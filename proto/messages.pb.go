...
type AnalyseVideoMessage struct {
...
func (x *AnalyseVideoMessage) Reset() {
	*x = AnalyseVideoMessage{}
	mi := &file_proto_messages_proto_msgTypes[0]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *AnalyseVideoMessage) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AnalyseVideoMessage) ProtoMessage() {}

func (x *AnalyseVideoMessage) ProtoReflect() protoreflect.Message {
	mi := &file_proto_messages_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use AnalyseVideoMessage.ProtoReflect.Descriptor instead.
func (*AnalyseVideoMessage) Descriptor() ([]byte, []int) {
	return file_proto_messages_proto_rawDescGZIP(), []int{0}
}

func (x *AnalyseVideoMessage) GetUploadId() int64 {
	if x != nil {
		return x.UploadId
	}
	return 0
...
func (x *AnalyseVideoMessage) GetVideoId() int64 {
	if x != nil {
		return x.VideoId
	}
	return 0
...
var file_proto_messages_proto_rawDesc = string([]byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x4d, 0x0a, 0x13, 0x41, 0x6e, 0x61, 0x6c, 0x79, 0x73,
	0x65, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x1b, 0x0a,
	0x09, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x08, 0x75, 0x70, 0x6c, 0x6f, 0x61, 0x64, 0x49, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x76, 0x69,
	0x64, 0x65, 0x6f, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x76, 0x69,
	0x64, 0x65, 0x6f, 0x49, 0x64, 0x42, 0x10, 0x5a, 0x0e, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x61, 0x70,
...
var file_proto_messages_proto_goTypes = []any{
	(*AnalyseVideoMessage)(nil), // 0: AnalyseVideoMessage
}
